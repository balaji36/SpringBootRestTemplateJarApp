...
/*public class RestTemplateClientApp {
	...
	{
		RestTemplate restTemplate = new RestTemplate();
		final String url = "http://localhost:8080/api/employees";
	...
	{
		RestTemplate restTemplate = new RestTemplate();
		final String url = "http://localhost:8080/api/employees/"+id;
	...
	{
		RestTemplate restTemplate = new RestTemplate();
		final String url = "http://localhost:8080/api/deletemployee/"+id;
